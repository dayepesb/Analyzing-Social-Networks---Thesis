...
public class GraphEditorDemo extends JApplet implements Printable {
	...
	String instructions2 = "<html>" + "<h3>All Modes:</h3>" + "<ul>"
	...
	public GraphEditorDemo() {
		...
		this.layout = new StaticLayout<Number, Number>(graph, new Dimension(800, 600));
		...
		help.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(vv, instructions2);
			}
		});
